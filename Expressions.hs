...
evalExp (e,s,m,(SUB):c)= evalMinus (e,s,m,c)
evalExp (e,s,m,(MUL):c)= evalMul (e,s,m,c)
evalExp (e,s,m,(EQU):c)= evalEq (e,s,m,c)
evalExp (e,s,m,(OR):c)= evalOr (e,s,m,c)
evalExp (e,s,m,(NOT):c)= evalNot (e,s,m,c)
