...
evalExp (e,s,m,[]) = (e,s,m,[])
evalExp (e,s,m,(ADD):c)= evalPlus (e,s,m,c)
evalExp (e,s,m,(SUB):c)= evalPlus (e,s,m,c)
evalExp (e,s,m,(MUL):c)= evalPlus (e,s,m,c)
evalExp (e,s,m,(EQU):c)= evalPlus (e,s,m,c)
evalExp (e,s,m,(OR):c)= evalPlus (e,s,m,c)
evalExp (e,s,m,(NOT):c)= evalPlus (e,s,m,c)
evalExp (e,s,m,(Cexp (Evar a)):c)= evalExp  (evalVar (e,s,m,(Evar a):c))
...
evalExp (e,s,m,(Cexp (EBool a)):c) = evalExp (evalT (e,s,m,(EBool a):c))
